...
Starting from the GreatVoyage-v4.4.0 (Rousseau) version, the FullNode supports JSON-RPC APIs. For details, please refer to: [JSON-RPC API](../../api/json-rpc/index.md)
