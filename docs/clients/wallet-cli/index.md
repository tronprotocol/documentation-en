...
A command-line wallet for [TRON](https://tron.network) and selected EVM networks — interactive in Java, agent-first in TypeScript.
...
| **Install**            | `git clone` + `cd wallet-cli/java && ./gradlew build` (see [Setup](java/index.md#setup))                                                            | `npm install -g @tron-walletcli/wallet-cli`                                                                                                                                                                                                                 |
