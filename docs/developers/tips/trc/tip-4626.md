...
TIP-4626 tokenized Vaults MAY implement [TIP-2612](https://github.com/tronprotocol/tips/blob/master/tip-2612.md) to improve the UX of approving shares on various integrations.
