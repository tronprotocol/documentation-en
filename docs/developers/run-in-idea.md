...
* Enable `Enable annotation processing` configuration item
      ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/IDE_annotation.png)
* Check the JDK version and make sure that `Oracle JDK 1.8` is used in IntelliJ IDEA
      ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/IDE_JDK.png)
...
* Search for `checkstyle` in [IDEA]->[Preferences]->[Plugins] to install the plugin
    ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/IDE_checkstyle.png)
...
* Code style configuration
    ...
    ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/IDE_checkStyleAll.png)
    ...
    ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/IDE_stylecheck.png)
...
![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/IDE_RunDebug.png)
...
![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/IDE_runjavaorgon.png)
...
![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/IDE_debug.png)
