...
* `protos/core/` - Data structure for communication between nodes and between modules within nodes
    ...
    * `OrgonInventoryItems.proto` - Data structure related to block transferring between nodes
    * `contract/` - Contract related data structures
    * `Orgon.proto` - Other important data structures, including accounts, blocks, transactions, resources, super representatives, voting, and proposals...
...
```
|-- /common/src/main/java/org/orgon
    |-- common
    |   |-- args
    |   |-- config
    |   |-- entity
...
```
|-- chainbase.src.main.java.org.ogon
    |-- common
    |   |-- bloom
    |   |-- error
    |   |-- overlay
...
* `core/` - The core code of the chainbase module
    ...
    * `db/` and `db2/`
        ...
        * `OrgonStoreWithRevoking.java` - It is the base class that supports rollbackable databases. All rollbackable databases are their implementations, such as `BlockStore`, `TransactionStore`, etc
...
```
|-- consensus/src/main/java/org/orgon/consensus
    |-- Consensus.java
...
```
|-- actuator/src/main/java/org/orgon/core
    |-- actuator
...
```
|-- crypto/src/main/java/org/orgon/common/crypto
...
```
|-- framework/src/main/java/org/orgon
    |-- common
    |   |-- application
    |   |-- backup
    |   |-- logsfilter
...
![image](https://github.com/alexozerov/documentation-en/master/images/chainbase_1.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/chainbase_2.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/chainbase_3.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/chainbase_4.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/chainbase_5.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/chainbase_6.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/chainbase_7.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/chainbase_8.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/chainbase_9.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/network_architecture.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/network_discoverinit.png)
...
* `DiscoverTask` is to discover more nodes that are closer to myself. It is executed every 30s. The execution flow is as follows:
    ![image](https://github.com/alexozerov/documentation-en/master/images/network_discovertask.png)
* `RefreshTask` is to expand the local k-bucket by random node ID, that is, to find nodes that are closer to the random node ID. It is executed every 7.2s. The execution process is as follows:
    ![image](https://github.com/alexozerov/documentation-en/master/images/network_refreshtask.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/network_updatek.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/network_connect.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/network_filterrule.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/network_syncflow.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/network_sync1.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/network_sync2.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/network_sync3.png)
...
![image](https://github.com/alexozerov/documentation-en/master/images/network_broadcastflow.png)
