...
| `timestamp` | int64 | No | Cutoff timestamp (ms); when missing or `0`, uses latest block time; when negative, returns `{}` |
...
| `timestamp` is not numeric (GET) | `{"Error": "class java.lang.NumberFormatException : <message>"}` |
