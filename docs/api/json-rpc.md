...
Add below items in node's [configuration file](https://github.com/alexozerov/java-orgon/blob/develop/framework/src/main/resources/config.conf), then enable or disable it:
```
node.jsonrpc {
