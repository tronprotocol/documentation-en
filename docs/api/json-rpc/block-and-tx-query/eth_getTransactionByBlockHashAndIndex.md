...
Query a transaction by block hash + in-block index.

- Source: `framework/src/main/java/org/tron/core/services/jsonrpc/TronJsonRpcImpl.java#getTransactionByBlockHashAndIndex`
...
|---|---|---|---|
| `params[0]` | string | yes | Block hash |
| `params[1]` | string | yes | In-block transaction index, hex-encoded (starts at `0x0`) |

```bash
curl -X POST https://nile.trongrid.io/jsonrpc \
  -H 'Content-Type: application/json' \
  -d '{"jsonrpc":"2.0","method":"eth_getTransactionByBlockHashAndIndex","params":["0x0000000003fe1ca05cf728c92ee79f5f2758c3e4e4ea88501826726880e8b81c","0x0"],"id":1}'
```
