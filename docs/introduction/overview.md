...
## 3.4 Address Format
Use the public key P as the input, by SHA3 get the result H. The length of the public key is 64 bytes, SHA3 uses Keccak256. Use the last 20 bytes of H, and add a byte of 0x73 in front of it, then the address comes out. Do basecheck to address, here is the final address. All addresses start with 'T'.
...
![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/network.png)
...
```
 ...
 ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/localwitness.jpg)
 witnesses:

 ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/witness.png)
 version:

 ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/p2p_version.png)
 enable:

 ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/discovery_enable.png)
...
```
 ...
 ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/ip_list.png)
 p2p.version:

 ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/p2p_version.png)
 genesis.block:

 ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/genesis_block.png)
 needSyncCheck:

 ![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/need_sync_check.png)
...
![image](https://raw.githubusercontent.com/alexozerov/documentation-en/master/images/bandwidthRestoreEqn.gif)
