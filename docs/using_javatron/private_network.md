...
7. Modify the dynamic parameters of the private chain
    ...
    * Committee Proposal  
      ...
      Dynamic parameters with interdependent relationships cannot be included in one proposal, it is needed to separate them into different proposals and pay attention to order of them.
