...
7. Modify the dynamic parameters of the private chain
    ...
    Dynamic parameters can be obtained by [getchainparameters](https://developers.tron.network/reference/wallet-getchainparameters). The current dynamic parameters and committee proposals related to dynamic parameters of main network can be seen [here](https://tronscan.io/#/sr/committee), dynamic parameters are called network parameters here.
    ...
    * Committee Proposal 
      ...
      Dynamic parameters with interdependent relationships cannot be included in one proposal, it is needed to separate them into different proposals and pay attention to order of the proposals.
