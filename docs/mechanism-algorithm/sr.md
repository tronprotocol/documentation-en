...
+ Query all the proposals list ([ListProposals](https://tronprotocol.github.io/documentation-en/api/http/witness-and-governance/listproposals/))
+ Query all the proposals list by pagination ([GetPaginatedProposalList](https://tronprotocol.github.io/documentation-en/api/http/witness-and-governance/getpaginatedproposallist/))
+ Query a proposal by proposal id ([GetProposalById](https://tronprotocol.github.io/documentation-en/api/http/witness-and-governance/getproposalbyid/))
